...
export default props => {
  ...
  const userConfig = {
    ...{'name':'umi-tabs-demo','theme':'PRO','locale':false,'showBreadcrumb':true},
    ...runtimeConfig || {}
  };
  ...
  return React.createElement(require("/sandbox/node_modules/@umijs/plugin-layout/lib/layout/index.js").default, {
    userConfig,
    ...props
  });
};
